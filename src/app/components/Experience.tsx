...
export default function Experience() {
  ...
  return (
    ...
    <div className="container mx-auto px-4 md:px-6">
      <h2 className="text-2xl md:text-3xl font-bold mb-8 md:mb-12 text-center text-gray-900">Experience</h2>
      <div className="grid gap-6 md:gap-8 max-w-4xl mx-auto">
        {experiences.map((exp, index) => (
          <div 
            key={index} 
            className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100"
          >
            <div className="space-y-3 md:space-y-4">
              <div>
                <h3 className="text-lg md:text-xl font-bold text-gray-900">{exp.title}</h3>
                <p className="text-purple-800 font-medium">{exp.company}</p>
